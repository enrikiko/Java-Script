...
//2
const char* ssid = "VilaVeronika1"; //WIFI Name, WeMo will only connect to a 2.4GHz network.
const char* password = "Julinka12"; //WIFI Password


//defining the pin and setting up the "server"
//3
int relayPin = 2; // The Shield uses pin 1 for the relay
